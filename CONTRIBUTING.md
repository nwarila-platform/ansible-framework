...
1. Create the role directory under the namespace that says what it is: `applications/` for
   software the host carries, `roles/` for a state the host exists in, `operating_systems/`
   for OS bootstrap and hardening
